        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="insert-doctor.jsp">Doctors Team</a>
                </li>
                <li class="nav-item">
                    ...
                    <div id="carouselDoc1" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/doc1.jpg" class="d-block w-100" alt="Doctor 1 Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="images/doc2.jpg" class="d-block w-100" alt="Doctor 1 Image 2">
                            </div>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card">
                    <div id="carouselDoc2" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/doc5.jpg" class="d-block w-100" alt="Doctor 2 Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="images/doc6.jpg" class="d-block w-100" alt="Doctor 2 Image 2">
                            </div>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card">
                    <div id="carouselDoc3" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/th.jpeg" class="d-block w-100" alt="Doctor 3 Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="images/doc4.jpg" class="d-block w-100" alt="Doctor 3 Image 2">
                            </div>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card">
                    <div id="carouselDoc4" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/doc7.jpeg" class="d-block w-100" alt="Doctor 4 Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="images/doc8.jpg" class="d-block w-100" alt="Doctor 4 Image 2">
                            </div>
                        </div>
